...
int main() {
    ...
    // If the user chooses to register, call the registration function
    } else if (m == 3) { 
        system("CLS");
        new_user();
    } else {
...
void admin() {
    system("color f4");
    gotoxy(43, 4);
    printf("Welcome to Maze Bank: Your Financial Labyrinth");
    login();
    if (verify() == 1) {
        if (m == 1)
            menu();
...
//New user register (opening account)
void new_user(){
    char c;
    struct record rec;
    FILE *f;
    ...
    do {
        ...
        scanf(" %[^\n]", rec.name);
        gotoxy(36, 9);
        printf("[2]. Enter Your Custome Account Number* : ");
        scanf(" %d", &rec.account);
        gotoxy(36, 10);
        ...
        scanf(" %[^\n]", rec.email);
        gotoxy(36, 13);
        printf("[6]. Enter Your Citizenship No (optional)    : ");
        scanf(" %[^\n]", rec.citiz);
        gotoxy(36, 14);
...
void add() {
    ...
    do {
        ...
        fwrite(&rec, sizeof(rec), 1, f);
        gotoxy(38, 17);
        printf("Customer Account Registration Successfully");
        i++;
        gotoxy(36, 19);
...
void deposit() {
    ...
    gotoxy(52, 21);
    printf("Cash Deposit Successfully");
    gotoxy(50, 24);
...
void about() {
    ...
    printf("-------------ABOUT US-------------");
    gotoxy(38,12);
    printf("This project has been created by Uday Mayank Dhodi.");
    gotoxy(26,13);
    printf("Introducing My Minor Bank Management System Project in C Programming.");
    gotoxy(40, 22);
    printf("Press any key to return back to main menu.");
    char z = getch();
    if (z == 13) {
